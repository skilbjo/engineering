...
RUN apt update \
    && apt install ca-certificates bash bash-completion bc coreutils curl git htop jq postgresql-client tree unzip vim zip \
    && apt install postfix mutt python3 python3-pip \
    && apt install python3-six python3-pyasn1 \
