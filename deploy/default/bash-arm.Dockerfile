...
RUN ["qemu-arm-static","/sbin/apk","add","--no-cache","-U","bash","bash-completion","bc","ca-certificates","coreutils","curl","cyrus-sasl-plain","git","htop","jq","nss","postgresql-client","tree","unzip","vim","zip"]
RUN ["qemu-arm-static","/sbin/apk","add","--no-cache","-U","python3-dev"]
