...
RUN apk add --no-cache -U openjdk8 bash bash-completion bc ca-certificates coreutils curl cyrus-sasl-plain git htop jq nss postgresql-client tree unzip vim zip \
